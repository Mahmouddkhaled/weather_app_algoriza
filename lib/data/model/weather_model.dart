...
class Current {
  ...
  Current.fromJson(Map<String, dynamic> json) {
    ...
    windDegree = (json['wind_degree'] as int ) .toDouble();
    ...
    cloud = (json['cloud'] as int).toDouble();
...
class Day {
  ...
  Day.fromJson(Map<String, dynamic> json) {
    ...
    mdoubleempC = json['mdoubleemp_c'];
    mdoubleempF = json['mdoubleemp_f'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mdoubleemp_c'] = this.mdoubleempC;
    data['mdoubleemp_f'] = this.mdoubleempF;
...
class Hour {
  ...
  Hour.fromJson(Map<String, dynamic> json) {
    ...
    dewpodoubleC = json['dewpodouble_c'];
    dewpodoubleF = json['dewpodouble_f'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dewpodouble_c'] = this.dewpodoubleC;
    data['dewpodouble_f'] = this.dewpodoubleF;
